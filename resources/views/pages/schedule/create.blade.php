          ...
          <div class="overflow-x-auto">
            <form method="POST" action="{{route('schedule.store')}}">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="time" id="start" name="start" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-blue-500 block w-full p-2.5">
              </div>
              <div style="margin-bottom: 1rem;">
                <label for="end" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">End</label>
                <input type="time" id="end" name="end" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-blue-500 block w-full p-2.5">
              </div>
