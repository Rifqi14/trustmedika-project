<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Detail Schedule</h2>
  </x-slot>
          ...
          <div class="overflow-x-auto">
            <form method="POST" action="{{route('clinic.store')}}">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <select disabled id="employee_id" name="employee_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <select disabled id="clinic_id" name="clinic_id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <select disabled id="day" name="day" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              ...
              <div style="margin-bottom: 1rem;">
                ...
                <input type="time" id="start" name="start" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-blue-500 block w-full p-2.5" readonly value="{{$schedule->start}}">
              </div>
              <div style="margin-bottom: 1rem;">
                <label for="end" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">End</label>
                <input type="time" id="end" name="end" class="border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-blue-500 block w-full p-2.5" readonly value="{{$schedule->end}}">
              </div>
